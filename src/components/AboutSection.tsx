          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {tools.map((tool, index) => (
                ...
                >
                  <div className={`w-12 h-12 mx-auto mb-3 rounded-lg bg-gradient-to-br ${tool.color} flex items-center justify-center text-2xl font-bold text-primary-foreground shadow-lg group-hover:shadow-xl transition-shadow`}>
                    {tool.name.charAt(0)}
                  </div>
